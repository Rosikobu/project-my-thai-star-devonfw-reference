...
public interface Bookingmanagement {
	...
	/**
	 * Returns a paginated list of Bookings matching the search criteria. Needs
	 * Authorization.
	 *
	 ...
	 * @return boolean <code>true</code> if the booking can be deleted,
	 ...
	 * @return boolean <code>true</code> if the invitedGuest can be deleted,
	 *         <code>false</code> otherwise
	 */
	 ...
	 * @return the new {@link InvitedGuestEto} that has been saved with ID and
	 *         version.
	 */
