...
const waiterCockpitServiceStub = {
  getArchivedOrders: jasmine.createSpy('getArchivedOrders').and.returnValue(of(orderData)),
};

const waiterCockpitServiceSortStub = {
  getArchivedOrders: jasmine.createSpy('getArchivedOrders').and.returnValue(of(ascSortOrder)),
};
